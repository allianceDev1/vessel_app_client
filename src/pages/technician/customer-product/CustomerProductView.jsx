...
const CustomerProductView = () => {
    ...
    useEffect(() => {
        dispatch(page.setTitle({ title: `Product : ${product_id}`, note: "Customer Product View" }))
        ...
        <div className="tech-customer-view-container">
            <div className="menu-box">
                <div className="slide-menus">
                    ...
                    <div className={`menu-item ${(activeSegment === 'spares') && 'active'}`} onClick={() => navigateSubMenu(`/tech/customer/${customer_id}/product/${product_id}/spares`)}>
                        <TbSquareLetterS />
                        <p>spares</p>
                    </div>
                    <div className={`menu-item ${(activeSegment === 'eligibility') && 'active'}`} onClick={() => navigateSubMenu(`/tech/customer/${customer_id}/product/${product_id}/eligibility`)}>
                        <TbCircleCheck />
                        <p>Eligibility</p>
                    </div>
                    <div className={`menu-item ${(activeSegment === 'service-cards') && 'active'}`} onClick={() => navigateSubMenu(`/tech/customer/${customer_id}/product/${product_id}/service-cards`)}>
                        <TbPlayCard4 />
                        <p>Service Cards</p>
                    </div>
                    <div className={`menu-item ${(activeSegment === 'package-history') && 'active'}`} onClick={() => navigateSubMenu(`/tech/customer/${customer_id}/product/${product_id}/package-history`)}>
                        <TbDropletBolt />
                        <p>Package History</p>
                    </div>
                </div>
