...
import '../../controller/customer-product/eligibility.scss'
...
const Eligibility = () => {
    ...
    const { data, isLoading, error } = useQuery({
        queryKey: ['customer_pr_eligibility', customer_id, product_id],
        queryFn: async () => {
            const data = await api.vfTv2Axios.get(`/product/${product_id}/eligibility`)
