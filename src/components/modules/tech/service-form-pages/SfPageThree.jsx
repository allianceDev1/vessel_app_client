...
const SfPageThree = ({ page }) => {
    ...
    return (
        <div className="tech-service-form-page sf-page-three">
            {/* Title */}
            ...
            {!loading && !error?.error && <div className='tech-sf-review-page'>
                ...
                <div className="submit-section">
                    <Button label={'Next'} rounded style={{ width: '100%' }} onClick={() => dispatch(sfSetting.setActivePage(103))} />
                </div>
            </div>}
        </div>
    )
